...
DriveBase::DriveBase() : frc::Subsystem("DriveBase") {
    ...
    sparkyRightLead.reset(new rev::CANSparkMax(2, rev::CANSparkMax::MotorType::kBrushless));
    differentialDrive1.reset(new frc::DifferentialDrive(*sparkyLeftLead, *sparkyRightLead));
    sparkyLeftFollow.reset(new rev::CANSparkMax(1, rev::CANSparkMax::MotorType::kBrushless));
...
frc::SmartDashboard::PutNumber("Right Encoder Vel", right_encoder.GetVelocity());
