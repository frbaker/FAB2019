...
#include "Subsystems/JacksBack.h"
...
JacksBack::JacksBack() : frc::Subsystem("JacksBack") {
   ...
   // cANSparkMAXJacksBack->SetRampRate(0.0);
}

void JacksBack::InitDefaultCommand() {
